...
namespace api.Medicamentos.Migrations
{
    ...
    [Migration("20220709142403_Add_Paciente_Medicamento_Tratamento")]
    partial class Add_Paciente_Medicamento_Tratamento
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("api.Medicamentos.Medicamento", b =>
                {
                    b.Property<Guid>("Id")
                    ...
                    b.ToTable("AppMedicamentos", (string)null);
                });

            modelBuilder.Entity("api.Medicamentos.Paciente", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppPacientes", (string)null);
                });

            modelBuilder.Entity("api.Medicamentos.Tratamento", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("Medicamento")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("Paciente")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("Id");

                    b.HasIndex("Medicamento");
            ...
            modelBuilder.Entity("api.Medicamentos.Tratamento", b =>
                {
                    b.HasOne("api.Medicamentos.Medicamento", null)
                        .WithMany()
                        .HasForeignKey("Medicamento")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("api.Medicamentos.Paciente", null)
                        .WithMany()
